...
# I need to move the test data insertion to python code
"""
# recruiters_data
...
# job_posting_data
PRAGMA foreign_keys = ON;
INSERT INTO job_posting (link, date_applied, description, interviewed, companyId, recruiterId,
contactId) VALUES ("www.link.com", "DATE1", "Description", "yep", 1, 1, 1);
